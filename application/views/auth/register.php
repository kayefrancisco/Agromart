...
<div class="form-container">
   <?php echo form_open_multipart('Auth/RegisterController/register'); ?>
      ...
      <?php endif; ?>
            ...
            <div class="form-group">
					<input type="text" name="txt_address" id="address" placeholder="Address" class="form-control" <?php echo set_value('txt_address'); ?> required>
               <small><?php echo form_error('txt_address');?></small>
				</div>
				<div class="row">
					<div class="form-group col-lg-6">
               ...
               <small><?php echo form_error('txt_cpass');?></small>
					...
					<div class="form-group" id="file_container">
                     ...
                     <input type="file" name="user_avtar" class="form-control" id="name" placeholder="Upload Photo" required>
